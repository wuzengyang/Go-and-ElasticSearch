...
const (
	...
	DISTANCE = "200km"
	// Needs to update
	PROJECT_ID = "around-176216"
	BT_INSTANCE = "around-post"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL = "http://34.211.119.152:9200"
)
...
/*	tbl := bt_client.Open("post")
	...
	mut.Set("Location", "lat", bigtable.Now(), []byte(p.Location.Lat))
	mut.Set("Location", "lon", bigtable.Now(),[]byte(p.Location.Lon))
